...
//						+ getString(R.string.dalvik_heap) + Constants.COMMA;
                heapData = getString(R.string.native_heap_alloc) + Constants.COMMA
                        + getString(R.string.native_heap_size) + Constants.COMMA
                        + getString(R.string.dalvik_heap_alloc) + Constants.COMMA
                        + getString(R.string.dalvik_heap_size) + Constants.COMMA;
            }
